    ...
    <div v-if="competitors.length > 0" class="space-y-4">
        <div class="flex justify-between items-center mb-6">
            ...
            <button
                ...
                class="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium cursor-pointer"
            >
                <svg
        ...
        >
            <div class="flex justify-between items-start mb-4">
                <div class="flex-1">
                    ...
                    <span
                        ...
                        class="inline-block px-3 py-1 text-sm font-medium rounded-full bg-blue-50 text-blue-700 border border-blue-200"
                    >
                ...
                <div class="flex items-center gap-3 ml-4">
                    ...
                    <button
                        ...
                        class="flex items-center gap-1 px-3 py-1.5 text-sm border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer"
            ...
            <div
                ...
                class="mb-3 p-4 rounded-lg bg-green-50 border border-green-200"
            >
                <p class="text-sm font-semibold text-green-800 mb-1">💪 Points forts</p>
                <p class="text-sm text-green-700">{{ competitor.strengths }}</p>
            </div>

            <div
                v-if="competitor.notoriety"
                class="mb-4 p-4 rounded-lg bg-purple-50 border border-purple-200"
            >
                <p class="text-sm font-semibold text-purple-800 mb-1">⭐ Notoriété</p>
                <p class="text-sm text-purple-700">{{ competitor.notoriety }}</p>
            </div>

            <div
                v-if="competitor.social_media && competitor.social_media.length > 0"
                class="mb-4 p-4 rounded-lg bg-indigo-50 border border-indigo-200"
            >
                <p class="text-sm font-semibold text-indigo-800 mb-3">📱 Réseaux sociaux</p>
                <div class="flex flex-wrap gap-2">
                    <a
                        ...
                        class="inline-flex items-center gap-2 px-3 py-2 bg-white rounded-lg border border-indigo-300 hover:bg-indigo-100 transition-colors text-sm"
                    >
                        <span>{{ getSocialMediaEmoji(social.platform) }}</span>
                        <div class="flex flex-col">
                            <span class="font-medium text-indigo-900">{{ social.platform }}</span>
